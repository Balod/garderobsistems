...
<body>
    <div class="wrap">
        <h1><span>Спасибо</span> за проявленный интерес!</h1>
        <a class="dnl-btn" href="https://yadi.sk/i/LWsjP-h0ZZRwFA">Скачать презентацию</a>
...
$subject = "Форма скачивания презентации";
$phone = $_POST['phone'];
$subjeckField = "Из формы: ";
$txt="";
/*------------Отправляем данные на почту------------*/
mail($to,$subject,$phone);
/*Обработка телефона для отправки в телеграм*/
